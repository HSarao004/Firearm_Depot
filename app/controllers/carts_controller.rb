class CartsController < ApplicationController
  ...
  def complete_order
    ...
    ActiveRecord::Base.transaction do
      ...
      order = current_user.orders.create!(order_params.merge(
                                            tax_id: Tax.find_by(region: @user_info.province).id, status: "new"
                                          ))
      ...
      unless process_stripe_payment(params[:stripeToken], order.total_with_tax)
